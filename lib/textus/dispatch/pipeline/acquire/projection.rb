    ...
    module Pipeline
      module Acquire
        ...
        class Projection
          ...
          def self.renderers
            @renderers ||= {
              "text" => Textus::Dispatch::Pipeline::Acquire::Serializer::Text,
              "json" => Textus::Dispatch::Pipeline::Acquire::Serializer::Json,
              "yaml" => Textus::Dispatch::Pipeline::Acquire::Serializer::Yaml,
            }
          end

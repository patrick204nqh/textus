    ...
    module Actions
      class KeyDeletePrefix < Base
        ...
        def call(container:, call:)
          ...
          leaves = Textus::Dispatch::Actions::List.new(prefix: @prefix).call(container: container)
          ...
          steps.each do |step|
            Textus::Dispatch::Actions::KeyDelete.new(key: step["key"]).call(container: container, call: call)
          end
          plan
        end
      end

module Textus
  module VerbRegistry
    ...
    register VerbSpec.new(
      ...
      [:cli, :mcp], { default: ->(v, _i) { v&.to_h_for_wire } }, nil, nil)
    ...
    register VerbSpec.new(
      ...
      [:cli, :mcp], { default: ->(env, _) { { "uid" => env.uid, "etag" => env.etag } } }, nil, nil)
    ...
    register VerbSpec.new(
      ...
      [:cli, :mcp], { cli: ->(rows, _) { { "entries" => rows } }, default: identity }, nil, nil)
    ...
    register VerbSpec.new(
      ...
      [:cli, :mcp], { default: identity }, "key delete", nil)
    ...
    register VerbSpec.new(
      ...
      [:cli, :mcp], { default: identity }, "key mv", nil)
    ...
    register VerbSpec.new(
      ...
      [:cli, :mcp], { default: ->(env, _) { env.to_h_for_wire } }, nil, :json)
    ...
    register VerbSpec.new(
      ...
      [:cli, :mcp], { default: identity }, "accept", nil)
    ...
    register VerbSpec.new(
      ...
      [ArgSpec[:pending_key, String, true, true, nil,
        "the queued proposal's key", nil, nil, nil, nil, :__unset]],
      [:cli, :mcp], { default: identity }, "reject", nil)
    ...
    register VerbSpec.new(
      ...
      [:cli, :mcp], { default: identity }, "enqueue", nil)
    ...
    register VerbSpec.new(
      ...
      [:cli, :mcp], { default: ->(env, _) { { "key" => env.key, "uid" => env.uid, "etag" => env.etag } } }, nil, nil)
    ...
    register VerbSpec.new(
      ...
      [:cli, :mcp], { default: identity }, nil, nil)
    ...
    register VerbSpec.new(
      ...
      [:cli, :mcp], { cli: ->(r, _) { { "verb" => "rule_explain" }.merge(r.transform_keys(&:to_s)) }, default: identity }, "rule explain", nil)
    ...
    register VerbSpec.new(
      ...
      [:cli, :mcp], { default: identity }, "schema show", nil)
    ...
    register VerbSpec.new(
      ...
      [:cli, :mcp], { default: identity }, "jobs", nil)
    ...
    register VerbSpec.new(
      ...
      [:cli, :mcp], { default: ->(v, _) { v.to_h } }, "data mv", nil)
    ...
    register VerbSpec.new(
      ...
      [:cli, :mcp], { default: ->(v, _) { v.to_h } }, "key mv-prefix", nil)
    ...
    register VerbSpec.new(
      ...
      [:cli, :mcp], { default: ->(v, _) { v.to_h } }, "key delete-prefix", nil)
    ...
    register VerbSpec.new(
      ...
      [:cli, :mcp], { default: ->(v, _) { v.to_h } }, "rule lint", nil)
  end
end

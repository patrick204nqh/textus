      ...
      module Pulse
        ...
        class Impl
          ...
          def audit_changes_since(seq)
            Reads::Audit::Impl.new(caps: @caps).call(seq_since: seq)
          end

          def freshness
            @freshness ||= Reads::Freshness::Impl.new(ctx: @ctx, caps: @caps)
          end
          ...
          def review_keys
            ...
            rows = Reads::List::Impl.new(caps: @caps).call(zone: "review")
...
Textus::Application::UseCase.register(:pulse, Textus::Application::Reads::Pulse, caps: :read)

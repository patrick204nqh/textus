      ...
      module Blame
        ...
        class Impl
          ...
          def call(key:, limit: nil)
            audit_rows = Textus::Application::Reads::Audit::Impl.new(caps: @caps).call(key: key, limit: limit)
...
Textus::Application::UseCase.register(:blame, Textus::Application::Reads::Blame, caps: :read)

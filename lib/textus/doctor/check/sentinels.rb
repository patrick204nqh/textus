        ...
        def parse_error_issue(sentinel_path)
          {
            ...
            "fix" => "delete #{sentinel_path} and re-run 'textus publish' to regenerate",
          }
        end
        ...
        def drift_issue(sentinel)
          {
            ...
            "fix" => "re-run 'textus publish' to overwrite, or copy the manual edit back into the store source",
          }
        end
      end
    end

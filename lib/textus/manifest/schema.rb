module Textus
  class Manifest
    # The manifest schema: its *data* — the closed coordination vocabulary
    # (LANES + derived) and the key whitelists / FIELD_REGISTRY. The validation
    # *walk* lives in Schema::Validator (ADR 0107); the public entry points below
    # delegate to it so callers keep speaking to `Schema`.
    module Schema

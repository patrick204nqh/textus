  ...
  module Hooks
    module Builtin
      ...
      def self.register_all
        Textus.on(:intake, :json) do |store:, config:, args:|
          _ = store
          _ = args
        ...
        Textus.on(:intake, :csv) do |store:, config:, args:|
          _ = store
          _ = args
        ...
        Textus.on(:intake, :"markdown-links") do |store:, config:, args:|
          _ = store
          _ = args
        ...
        Textus.on(:intake, :"ical-events") do |store:, config:, args:|
          _ = store
          _ = args
          events = []
          current = nil
        ...
        Textus.on(:intake, :rss) do |store:, config:, args:|
          _ = store
          _ = args

...
| [0063](./0063-cli-is-a-projection-of-the-contract.md) | The CLI is a projection of the contract: a generic runner derives command/flags/dispatch from `Contract`, per-verb classes shrink to behavior-only escape hatches, reconciliation guard goes total — closes the hand-wiring gap behind 0058/0059/0061 | Proposed |

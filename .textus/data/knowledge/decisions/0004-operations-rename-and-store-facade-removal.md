...
**Status:** Partially superseded by [ADR 0010](0010-flat-operations-api.md) — the Store-facade removal shipped (v0.12.2); the `Operations` surface this ADR renamed was later flattened to one method per use case by 0010.
**Date:** 2026-05-26

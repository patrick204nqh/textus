...
RSpec.describe "Entry strategy: serialize_for_put" do
  describe "Markdown" do
    it "uses body as the serialized payload; content is nil" do
      bytes, meta, body, content = Textus::Entry::Markdown.serialize_for_put(
  ...
  describe "Json" do
    it "with explicit content: serializes meta+content" do
      bytes, meta, _, content = Textus::Entry::Json.serialize_for_put(
    ...
    it "without body or content: raises" do
      expect do
        Textus::Entry::Json.serialize_for_put(meta: {}, body: nil, content: nil, path: "/x/foo.json")
  ...
  describe "Text" do
    it "uses body as bytes; content nil" do
      bytes, _, body, content = Textus::Entry::Text.serialize_for_put(

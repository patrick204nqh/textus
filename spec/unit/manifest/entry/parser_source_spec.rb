...
RSpec.describe Textus::Manifest::Entry::Parser do
  describe ".parse_source" do
    ...
    it "builds a Source policy from a command block" do
      raw = { "source" => { "from" => "external", "command" => "make" } }

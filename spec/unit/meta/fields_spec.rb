...
RSpec.describe Textus::Meta do
  describe ".inject_all" do
    ...
    it "returns text entry unchanged (no metadata channel)" do
      meta, content = described_class.inject_all({}, {body: "raw"}, {}, format: "text")

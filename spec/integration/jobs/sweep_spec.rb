RSpec.describe Textus::Jobs::Sweep do
  ...
  it "calls Runtime::Retention::Apply with the scope" do
    ...
    instance = instance_double(Textus::Jobs::Retention, call: nil)
    allow(Textus::Jobs::Retention).to receive(:new).and_return(instance)

...
#   let(:store)   { ... }
#   let(:perform) { -> { store.with_role("automation").entry(:put, key: "feeds.foo", meta: {}, body: "x") } }
#
...
#   let(:store) { ... }
#   let(:canon_forbidden_action) { -> { store.with_role("automation").entry(:put, key: "knowledge.bar", …) } }

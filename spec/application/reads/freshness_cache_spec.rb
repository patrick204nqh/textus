...
RSpec.describe Textus::Application::Reads::Freshness, "verdict cache" do # rubocop:disable RSpec/DescribeMethod
  ...
  it "memoizes evaluator output for unchanged (key, last_refreshed_at)" do
    ...
    fr = described_class::Impl.new(ctx: ctx, caps: Textus::Application.caps_from_store(store)[0], evaluator: counter)
    fr.call
    fr.call

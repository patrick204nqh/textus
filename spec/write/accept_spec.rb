...
RSpec.describe Textus::Write::Accept do
  ...
  let(:store) do
    store_from_manifest(root, zones: ["working/network/org", "review"], manifest: <<~YAML)
      ...
      entries:
        - { key: working.network.org, path: working/network/org, zone: working, schema: null, owner: human:o, nested: true, kind: nested }
        - { key: review, path: review, zone: review, schema: null, owner: human:o, nested: true, kind: nested }
    YAML
  end
    ...
    let(:store) do
      s = store_from_manifest(root, zones: %w[working review], manifest: <<~YAML)
        ...
        zones:
          ...
          - { name: review, kind: queue }
        entries:
          - { key: working.n, path: working/n.md, zone: working, schema: null, owner: human:o, kind: leaf }
          - { key: review, path: review, zone: review, schema: null, owner: human:o, nested: true, kind: nested }
        rules: []
      YAML
      s.as("agent").put(
        ...
        store_from_manifest(
          ...
          manifest: <<~YAML,
            ...
            zones:
              ...
              - { name: review,  kind: queue }
            entries:
              - { key: working.network.org, path: working/network/org, zone: working, schema: org-member, owner: human:o, nested: true, kind: nested }
              - { key: review, path: review, zone: review, schema: null, owner: human:o, nested: true, kind: nested }
            rules:
